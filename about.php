...
<style>
    ...
    <body>
        ...
        <header class="main_header fixed_header">
            <div class="container clearfix">
                <div class="logo_head">
                    <a href="index.php"
                        ><img src="assets/images/irctc-new-logo.png" alt=""
                    /></a>
                </div>
                <div class="navbar-expand-lg nav_btn_toggle">
                    <button
                        class="navbar-toggler open_mobile_menu"
                        type="button"
  ...
  <ul>Hello <?php echo $_SESSION['username'];?></ul>
        ...
        <div class="inner-page-header about-page-header">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="tagline">ABOUT US</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="aboutsection">
                            <p>
                                ...
                                Ltd. (IRCTC) is a “Mini Ratna (Category-I)”
                                Central Public Sector Enterprise under Ministry
                                of Railways, Government of India.
                            </p>
                            <ul class="liststylingsk">
                                <li>
                                    This is the Replica of Official Site of
                                    IRCTC, Used for Mini Project
                                </li>
                            </ul>
                            <br />
                            <hr />
        ...
        <footer>
            ...
            <div class="copyright">
                © 2021 IRCTC | MINI PROJECT BY KARNA KUMAR CHAUDHARY.
            </div>
        </footer>
        <a
            id="back-to-top"
